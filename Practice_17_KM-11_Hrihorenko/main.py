            ...
            if inpt == '1':
                while w:
                    try:
                        ...
                        if num > 0:
                            print(f'Your result is: {factorial.factorial.fact(num)}')
                            w = 0
                        else:
                            raise
                    except:
                ...
                while w:
                    try:
                        ...
                        print(f'Your result is: {exp_root.exponentiation.exp2(num)}')
                        w = 0
                    except:
                        print('Oops! Not valid value.')
            elif inpt == '3':
                while w:
                    try:
                        num = float(input('Enter number: '))
                        print(f'Your result is: {exp_root.exponentiation.exp3(num)}')
                        w = 0
                    except:
                        print('Oops! Not valid value.')
            elif inpt == '4':
                while w:
                    try:
                        ...
                        if num > 0:
                            print(f'Your result is: {exp_root.root.root2(num)}')
                            w = 0
                        else:
                            raise
                    except:
                ...
                while w:
                    try:
                        num = float(input('Enter a positive number: '))
                        if num > 0:
                            print(f'Your result is: {exp_root.root.root3(num)}')
                            w = 0
                        else:
                            raise
                    except:
                ...
                while w:
                    try:
                        ...
                        if a > 0 and a != 1 and b >0:
                            print(f'Your result is: {logarithm.logarithm.log(b, a)}')
                            w = 0
                        else:
                            raise
                    except:
                ...
                while w:
                    try:
                        ...
                        if b >0:
                            print(f'Your result is: {logarithm.logarithm.ln(b)}')
                            w = 0
                        else:
                            raise
                    except:
                ...
                while w:
                    try:
                        b = float(input('Enter a number: '))
                        if b >0:
                            print(f'Your result is: {logarithm.logarithm.lg(b)}')
                            w = 0
                        else:
                            raise
                    except:
